# LabVIEW Examples — XD-C Motor Controller

Xeryon's LabVIEW library handles all communication between the computer and an **XD-C** controller, and exposes simple functions to control the connected stage. It's compact and easy to use.
...
- An XD-C controller connected over a COM (serial) port
